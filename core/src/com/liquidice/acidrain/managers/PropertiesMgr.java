...
public class PropertiesMgr {
    ...
    //Unlocked ScreenMgr
    public static String POWERUP_MULTIPLIER_TITLE = "ScoreMgr Multipliers!";
    public static String POWERUP_MULTIPLIER_DESC = "Earn up to x6 points from a Single Drop";
    public static String POWERUP_HEALTHPACK_TITLE = "Health Packs!";
    ...
    public static String ITEM_UNLOCKED_TEXT = "PowerupMgr Unlocked!";
    public static String UNLOCKED_HOLD_TEXT = "Long touch to play Level " + GameplayMgr.getLevel() + 1;
    ...
    //Level Complete ScreenMgr
    public static String NEXT_LEVEL_TEXT = "Touch anywhere to begin Level " + GameplayMgr.getLevel() + 1;
    public static int NORTH_OF_CENTER = 50;
    public static int PERFECT_SCORE = 100;

    //Game Over ScreenMgr
    public static String GAME_OVER_TEXT = "Touch anywhere for Main ScreenMgr";
    
    //ScoreMgr Overlay ScreenMgr
    public static String CLEAN_WATER_TEXT = "Clean Water";
    public static String CLEAN_WATER_PERCENT = ScoreMgr.getCaughtPercentage() + "%";
    public static String CITY_STRENGTH_TEXT = "City Strength";
    public static String CITY_STRENGTH_PERCENT = ScoreMgr.getStrengthPercentage() + "%";
