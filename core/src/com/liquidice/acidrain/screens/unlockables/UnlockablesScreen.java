...
public class UnlockablesScreen {
    ...
    public static void display() {
        ...
        unlockedItemLayout.setText(Font.unlockedItemFont, unlockedItemText);
        Font.unlockedItemFont.draw(stage.getBatch(), unlockedItemText, Gdx.graphics.getWidth() / 2 - unlockedItemLayout.width / 2, Properties.UNLOCKED_ITEMS_Y);
        //Level 5 - Multipliers
        drawUnlockable(Gameplay.getLevel() >= Properties.UNLOCK_1_LEVEL ? Textures.unlockableMultipliers : Textures.unlockableLocked, Properties.UNLOCK_1_Y);

        //Level 10 - UHealth Pack
        drawUnlockable(Gameplay.getLevel() >= Properties.UNLOCK_2_LEVEL ? Textures.unlockableHealthPack : Textures.unlockableLocked,Properties.UNLOCK_2_Y);

        //Level 15 - Umbrella
        drawUnlockable(Gameplay.getLevel() >= Properties.UNLOCK_3_LEVEL ? Textures.unlockableUmbrella : Textures.unlockableLocked,Properties.UNLOCK_3_Y);
